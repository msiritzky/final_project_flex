...
Visualization 1 {data-orientation=rows}
=========================
...
viz_2_final <- covid_data_prevent %>% 
  ...
  labs(title = "Early-pandemic adoption of protective health behaviors varied considerably by country")
viz_2_final
```
...
viz_4 <- avg_prevent_age %>% 
  ...
  xlab("Age group") +
  ylab("") + 
  labs(title = "Adoption of preventive behaviors varies by age across countries")
viz_4
```
